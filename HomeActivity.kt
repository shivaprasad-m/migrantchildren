...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recycler.adapter = HistoryInfo(mHistory, object : HistoryInfo.OnItemClickListener{
            override fun onItemClick(data: RunData) {
                ...
                var detailIntent: Intent = Intent(applicationContext, DetailInfo::class.java)
                detailIntent.putExtra(DetailInfo.EXTRA_DATA, dataMap)
        ...
        fab.setOnClickListener {
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                startActivity(Intent(this, TrackInfo::class.java))
            } else {
